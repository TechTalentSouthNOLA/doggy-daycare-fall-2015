...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { breed_id: @dog.breed_id, dob: @dog.dob, medical_conditions: @dog.medical_conditions, name: @dog.name, owner_id: @dog.owner_id }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { breed_id: @dog.breed_id, dob: @dog.dob, medical_conditions: @dog.medical_conditions, name: @dog.name, owner_id: @dog.owner_id }
    assert_redirected_to dog_path(assigns(:dog))
  end
